...
INSERT INTO properties (owner_id, property_name, property_description, location_name, latitude, longitude, property_type, amenities, rules, check_in_time, check_out_time, price_per_night, capacity, number_of_reviews, average_rating, is_active, note_from_owner) VALUES
(1, 'Riverside Retreat', 'Secluded campsite by the flowing river, perfect for fishing and relaxation.', 'Riverbend Valley', 40.7128, -74.0060, 'Tent', 'Picnic table, fire pit, potable water nearby', 'No loud music after 10 PM, respect wildlife.', '14:00', '11:00', 35.00, 4, 15, 4.8, TRUE, 'Enjoy the sounds of nature!'),
(3, 'Mountain Top Cabin', 'Cozy cabin with stunning panoramic mountain views.', 'Eagle Peak', 34.0522, -118.2437, 'Cabin', 'Full kitchen, bathroom with shower, fireplace, private deck', 'No smoking inside, pets allowed on leash.', '15:00', '10:00', 75.00, 2, 22, 4.5, TRUE, 'Bring warm clothes, nights can be chilly.'),
(1, 'Forest Glamping Tent', 'Luxury camping experience in a spacious and stylish tent.', 'Whispering Woods', 51.5074, 0.1278, 'Glamp', 'Comfortable beds, solar lighting, outdoor seating area', 'Leave no trace, quiet hours from 11 PM.', '16:00', '12:00', 60.00, 3, 8, 4.9, TRUE, 'Experience the beauty of the forest in comfort.'),
(3, 'Lakeside RV Spot', 'Spacious RV spot with full hookups right by the serene lake.', 'Clearwater Lake', 37.7749, -122.4194, 'RV', 'Electric hookup, water hookup, sewage dump station', 'Maximum stay 7 days, respect other campers.', '13:00', '12:00', 50.00, 6, 5, 4.2, TRUE, 'Great for boating and fishing enthusiasts.');
